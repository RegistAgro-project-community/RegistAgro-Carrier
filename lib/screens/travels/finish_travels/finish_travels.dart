...
class FinishTravelsTab extends StatefulWidget {
  final List<Map<String, String>> corridas;
  const FinishTravelsTab({super.key, required this.corridas});

  @override
  State<FinishTravelsTab> createState() => FinishTravelsTabState();
}

class FinishTravelsTabState extends State<FinishTravelsTab> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "As viagens que você finalizar aparecerão aqui.",
